...
// import { HiOutlineFilter, HiChevronDown, HiOutlineViewGrid, HiMinus } from 'react-icons/hi'
...
const Filter: React.FC<{ products: any[] }> = ({ products }) => {
          ...
          <div className="relative z-10 flex items-baseline justify-between pt-12 pb-6 border-b border-gray-200">
            ...
            <div className="flex items-center">
              ...
              >
                ...
                <HiOutlineFilter className="w-5 h-5" aria-hidden="true" />
              </button>
            </div>
          </div>
